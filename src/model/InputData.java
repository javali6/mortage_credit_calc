...
public class    InputData {
    ...
    private BigDecimal wiborPercent = new BigDecimal("3.05");

    private BigDecimal amount = new BigDecimal("300000");

    private BigDecimal monthsDuration = BigDecimal.valueOf(180);

    private BigDecimal bankMarginPercent = new BigDecimal("1.95");
    ...
    private BigDecimal overpaymentProvisionPercent = BigDecimal.valueOf(0.02);
    private BigDecimal overpaymentProvisionMonths = BigDecimal.valueOf(12);
