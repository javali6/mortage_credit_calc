...
public class RateAmounts {
    ...
    public RateAmounts(BigDecimal rateAmount, BigDecimal interestAmount
            , BigDecimal capitalAmount, Overpayment overpayment) {
    ...
    public BigDecimal getCapitalAmount() {
        return capitalAmount.setScale(2, RoundingMode.UP);
    }
